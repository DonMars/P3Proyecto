...
namespace Profe
{
    ...
    public class MovementController : MonoBehaviour
    {
        ...
        private void Movement()
        {
            ...
            rbPlayer.velocity = transform.localRotation * new Vector3(HorizontalInput(), 0, VerticalInput()) * (Time.deltaTime * Speed());
        }

        private float Speed()
        {
            return CrouchInput() ? crouchSpeed : RunInput() ? runSpeed : walkSpeed;
        }
